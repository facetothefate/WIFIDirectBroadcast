...
abstract public class AbstractPacketizer {
	...
	protected static int rtphl = 12;

	protected ECRtpSocket ecsocket = null;
	protected RtpSocket socket =null;
	protected InputStream is = null;
	protected boolean running = false;
	protected byte[] buffer;
	protected int videoFps=30;
	protected int mode = DEVICEMODE;
	protected long ts =0;
	public final static int FILEMODE = 0x01;
	public final static int DEVICEMODE = 0x02;
	
	public void setFileMode(){
		this.mode=AbstractPacketizer.FILEMODE;
	}

	public AbstractPacketizer() throws IOException {
		socket = new RtpSocket();
		ecsocket=new ECRtpSocket();
	...
	public void setDestination(InetAddress dest, int dport) {
		...
		ecsocket.setDestination(dest, dport);
		//Log.d("AbstractPacketizer","dest address"+ dest +":"+dport);
	}
	...
	public void setMode(int filemode) {
		// TODO Auto-generated method stub
		
	}

	public void setMaxFrame(long videoCount) {
		// TODO Auto-generated method stub
		
	}

	public void setTunnelChannel(String string) {
